...
# at the bottleneck
class UNetPix(TrainableModel):
    def __init__(self, input_nc=3, output_nc=3, num_downs=6, ngf=64,
                 norm_layer=nn.GroupNorm, use_dropout=False):
        super().__init__()
...
class UnetSkipConnectionBlock(nn.Module):
    def __init__(self, outer_nc, inner_nc, input_nc=None,
                 submodule=None, outermost=False, innermost=False, norm_layer=nn.GroupNorm, use_dropout=False):
