...
def main(curvature_step=0, depth_step=0):
    ...
    def mixed_loss(pred, target):
        ...
        return cycle + gray, (cycle.detach(), gray.detach())
    ...
    logger.add_hook(partial(jointplot, logger=logger, loss_type="gray_loss"), feature="val_gray_loss", freq=1)
    ...
    def dest_transforms(x):
        ...
        gray = torch.FloatTensor(image).unsqueeze(0)
        return gray
