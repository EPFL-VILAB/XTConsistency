...
def main(curvature_step=0, depth_step=0, method=1):
    ...
    def mixed_loss(pred, target, data):
        ...
        return inverse + curvature_weight*curvature + depth_weight*depth, (inverse.detach(), curvature.detach(), depth.detach())
    ...
    plot_images(model, logger, test_set, ood_images, mask_val=0.502, 
        loss_models={"curvature": curvature_model, "depth": depth_model, "curvature_cycle": curve_cycle, "rgb": normal2rgb})
