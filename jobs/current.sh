...
job run --instance cloud1 --config "SAMPLEFF_baseline_fulldata_opt" "python -m experiments.train_percep baseline --batch-size 128 --early-stopping 40 --max-epochs 200" --shutdown
