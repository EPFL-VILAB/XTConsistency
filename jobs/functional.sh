...
job run --instance cloud3 --config "F_wGTinflux_curvAB_depthAB" "python -m experiments.train_functional wGTinflux_curvAB_depthAB"
job run --instance cloud3 --config "F_wGTinflux_curvA_depthviacurvA" "python -m experiments.train_functional wGTinflux_curvA_depthviacurvA"
...
job run --instance cloud8 --config "F_wGTinflux_curvA_depthA_trianglecurve2depth_gt" "python -m experiments.train_functional wGTinflux_curvA_depthA_trianglecurve2depth_gt"
