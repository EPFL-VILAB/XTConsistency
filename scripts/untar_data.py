...
def process_file(file, result_loc="/home/nikcheerla/scaling/mount/data2/taskonomy3", flags="-C"):
	...
	data_full_len = len(glob.glob(f'/home/nikcheerla/scaling/mount/data/taskonomy3/{building}_segment_semantic/**', recursive=True))
	data_len = len(glob.glob(f'/home/nikcheerla/scaling/mount/data2/taskonomy3/{building}_{task}/**', recursive=True))
...
def main(filename="data/alllinks.txt", tasks=['reshading', 'keypoints2d', 'keypoints3d', 'edge_occlusion', 'segment_semantic']):
